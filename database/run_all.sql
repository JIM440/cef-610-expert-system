-- Master script: run all migrations then seeds in order
-- Usage: psql -U postgres -d crop_expert_system -f database/run_all.sql
...
\i seeds/002_seed_symptoms.sql
\i seeds/005_seed_environmental_conditions.sql
\i seeds/004_seed_treatments.sql
\i seeds/003_seed_diseases.sql
\i seeds/006_seed_rules.sql
\i seeds/007_seed_rule_treatments.sql
\i seeds/008_seed_users.sql
